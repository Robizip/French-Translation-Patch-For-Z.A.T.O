define tc = Character("[[PROFESSEUR]", color="#ffffff",)
...
translate french start_2b370c74:
    ...
    "Savais-tu que notre Soleil était une étoile très inabituelle?"
...
translate french start_c9aa57f0:
    ...
    extend " Donc c’est un cas particulier même parmi celles-ci."
...
translate french start_3c22fee5:
    ...
    "La majorité de sa surface est lumineuse - en réalité, il y a trois fois plus de tâches claires que de tâches foncées."

# game/script.rpy:81
translate french start_7d12504d:

    # "Sure, its overall brightness index is nothing special."
    "Bien sûr, son indice global de luminosité n’a rien de spécial."

# game/script.rpy:82
translate french start_e44aabaa:

    # extend " You could even call it underwhelming compared to other stars of its type."
    extend " Il pourrait même être qualifié de décevant comparé aux autres étoiles de sa catégorie."

# game/script.rpy:83
translate french start_9ea3fb72:

    # "But even so, it works harder than most to shine as bright as it can."
    "Et pourtant, le Soleil travaille encore plus dur que les autres pour briller aussi fort que possible."
...
translate french start_ce4b1e27:
    ...
    extend " Mais cela devait être il y a quelques années dans un journal."
...
translate french start_e19da8bc:
    ...
    extend " C’est pas non plus terrible comme ciel et comme soleil."

# game/script.rpy:97
translate french start_a69c39d1:

    # extend " I guess that’s the kind of region it is."
    extend " Mais j’imagine que ce sont les conditions régionales."
...
translate french start_f63310dd:
    ...
    extend " C’est à un point où j’ai commencé à me demander si nous ne sommes pas juste le résultat d’une pure chance."
...
translate french start_526fb5ae:
    ...
    extend " Cette conscience a besoin d’émerger plus tard, dès lors que l’enfant développe une conscience de soi."
...
translate french start_0b00e471:
    ...
    "De quoi l’univers dans sa toute sa globalité pourrait-\nt-il être curieux?"
...
translate french start_96d76f07:
    ...
    "Il n’y a rien d’autre qui puisse assez compter dans tout le monde entier!"
...
translate french start_11c3dbf5:
    ...
    extend " J’imagine que l’univers n’a d’autre choix qu’être autocentré."
...
translate french start_8e4403d1:
    ...
    extend " Je crois que j’ai enfin compris!"
...
translate french start_1d445be1:
    ...
    "C’est de là le meilleur et unique passe-temps qui existe,\nd’aussi loin que le monde puisse être concerné."
...
translate french start_7bb963bb:
    ...
    extend " On peut même dire que sa valeur d’observation est égale à l’infini."
...
translate french start_2dcb8741:
    ...
    "Alors, il a dû créer de nouveaux observateurs finis pour les ajouter à sa propre infinité - C’était nécessaire pour créer la vie sentiente."
...
translate french start_b1edf035:
    ...
    "Quand je l’énonce de cette manière, cela sonne comme si nous étions tous des invités supplémentaires à une fête..."
...
translate french start_064dcf7d:
    ...
    "Cet univers vaste et puissant s’est changé si méticuleusement pour créer de nouveaux observateurs possibles, il a ajusté si précisémment tous ses systèmes..."
...
translate french start_653f65fc:
    ...
    extend " Oh non, ça ne peut pas être...!"
...
translate french start_5ec13ae8:
    ...
    g "Oh Disparition, laisse-moi tranquille!"
...
translate french start_3a569376:
    ...
    extend " Hé, allons tous signaler chaqu’un d’entre nous comme disparu et regardons lequel sera retrouvé en premier."
...
translate french start_fa9c199a:
    ...
    "Quand j'avais commencé à entendre parler de sa disparition, la première pensée qui m'était venu à l'esprit était assez sale."
...
translate french start_e96842fe:
    ...
    extend " et en dépit de ce que je pensais personnellement, ça restait une personne disparue."
...
translate french start_1c85b8ef:
    ...
    extend " Rien qu’imaginer ça me chagrinait."
...
translate french start_cd657ead:
    ...
    "Ce n’était pas comme si nous étions déjà amis."
...
translate french start_7e29faee:
    ...
    "Ils avaient raison, ça ne serait pas la premier fois qu'Ira partît on ne sait où pour aucune bonne raison."
...
translate french start_208f65d4:
    ...
    extend " Je n'avais jamais vu ou entendu quelque chose comme ça."
...
translate french start_2eec9a39:
    ...
    extend "Je suppposais que c'est possible, sachant comment étaient certaines filles."
...
translate french start_802aedc6:
    ...
    extend " Même quand je n’énonçait comme ça, cela en devenait presque..."

# game/script.rpy:380
translate french start_21adb742:

    # extend " Yeah, it’s most definitely cute."
    extend " Ouais, c’était vraiment mignon."
...
translate french start_a92c0db8:
    ...
    extend " Je ne l’avais jamais prise comme une romantique."

# game/script.rpy:385
translate french start_7f9f9613:

    # extend " But she is a girl at the end of the day."
    extend " Mais au final, ça restait quand même une fille."

# game/script.rpy:386
translate french start_d9ea39f4:

    # extend " And she does like those types of books..."
    extend " Et elle aimait sans doute ce type de livres..."
...
translate french start_abb554b5:
    ...
    "Mais d’un autre côté, j’étais vraiment..."
...
translate french start_d14e7e2c:
    ...
    "C’était égoïste et si stupide, mais si Ira avait vraiment disparue..."

# game/script.rpy:402
translate french start_f0080d7b:

    # extend " It's like I've got nothing to hope for anymore."
    extend " C'était comme si je n'avais plus d'espoir en rien."
...
translate french start_78c1fd43:
    ...
    extend " Qu’importe ce que je ferais, ils allaient continuer à rire."

# game/script.rpy:446
translate french start_a3d95d5c:

    # "If Ira came in through the door right now and heard what they were saying..."
    "Si Ira passait la porte là maintenant et qu’elle entendait tout ce qu’ils disaient..."
...
translate french start_4ce935a4:
    ...
    "Je veux dire, elle n’avait “disparue” qu’un jour."

# game/script.rpy:449
translate french start_6d8cc217:

    # extend " She's probably just coming late today."
    extend " Elle\nallait probablement juste venir plus tard aujourd’hui."

# game/script.rpy:450
translate french start_51dba0f9:

    # extend " She doesn't even know there's a missing report."
    extend " Peut-être qu’elle ne savait même pas qu’il y a eu un signalement de disparition."

# game/script.rpy:451
translate french start_8658fba2:

    # "Maybe she has already left her lover’s place."
    "Peut-être qu’elle avait déjà quitté la maison de son amant."

# game/script.rpy:452
translate french start_5f0cf7d2:

    # extend " Maybe she's trudging through our snowy schoolyard as we speak."
    extend " Peut-être qu’elle était en train de progresser péniblement dans toute la neige de la cour pendant qu'on parle."
...
translate french start_cfb074dd:
    ...
    "Elle a déjà laissé son épaisse veste imperméable au vestiaire."
...
translate french start_39648e48:
    ...
    extend sadaway " Je ne lui ai jamais\nparlé, comme je vous l’ai dit..."

# game/script.rpy:473
translate french start_730596c1:

    # "The steps walk past the classroom."
    "Les pas passèrent devant de la salle de classe."

# game/script.rpy:474
translate french start_0fd54a8a:

    # extend " Now that they're closer, they don't sound like her at all."
    extend " Maintenant qu’ils étaient plus proches, ils ne sonnaient pas du tout comme elle."
...
translate french start_8b242d0c:
    ...
    extend " Ce n’était pas comme si ça marchait de tout façon alors pourquoi je continuais à le faire?"

# game/script.rpy:508
translate french start_f9e0c1bf:

    # "I plop down at my desk and start mindlessly flipping through the textbook."
    "Je me laissai tomber sur mon bureau et commençai sans réfléchir à feuilleter le manuel."

# game/script.rpy:509
translate french start_9b44fe0b:

    # extend " I need to stop indulging fantasies like that."
    extend " Je devrais vraiment arrêter de me laisser aller à ce genre de fantaisies."

# game/script.rpy:510
translate french start_3500765a:

    # extend " It just makes me feel stupid every time."
    extend " Ça me faisait juste me sentir plus stupide à chaque fois."
...
translate french start_a2eff528:
    ...
    "Si Ira passait cette porte et les tabassait sur-le-champ, est-ce que ça réglerait vraiment le problème?"

# game/script.rpy:512
translate french start_1e7532a0:

    # "They'd probably keep saying those same things behind her back."
    "Elle disait probalement les mêmes choses derrière mon dos."
...
translate french start_a45aeb59:
    ...
    "J’imagine que ça serait encore pire."
...
translate french start_849ebc50:
    ...
    extend " C’était une bonne chose, une très bonne chose."
...
translate french start_f234dcd7:
    ...
    extend " Ira avait toujours eu un fort taux d’absence en cours."

# game/script.rpy:539
translate french start_6e99bb30:

    # "So I assume she skipped as usual..."
    "Alors j’en déduis qu’elle avait séché les cours comme à son habitude..."

# game/script.rpy:540
translate french start_f9c2bd3c:

    # extend " and went to see that man they talked about?"
    extend " et qu’elle était allée voir l’homme dont ils parlent tous?"

# game/script.rpy:541
translate french start_677a1ab7:

    # extend " Did she go to him right away?"
    extend " Était-elle allée le voir immédiatement?"
...
translate french start_61e86d26:
    ...
    "Le bureau des professeurs, était-ce...?"

# game/script.rpy:568
translate french start_899e030c:

    # "I’m kinda scared of going straight to the police."
    "J’avais assez peur d’aller directement voir la police."
...
translate french start_4e2dea3b:
    ...
    extend " J’allais le regretter énormément!"

# game/script.rpy:580
translate french start_179c806b:

    # "Oh, but I might also be tearing star-crossed lovers apart..."
    "Oh, mais j’allais peut-être aussi déchirer en mille morceau un bel amour maudit..."
...
translate french start_b5db9ce2:
    ...
    "Si Ira s’était vraiment enfuie avec quelqu’un dont elle tenait tant à cœur, loin du ridicule de la société, est-ce que ça serait vraiment juste de ruiner tout ça?"
...
translate french start_b6db7069:
    ...
    "Je voulais dire, c’était vraiment beau, et je crois que juger un amour comme celui-ci est vraiment nul, nul, nul, mais dès que j’y réfléchis un peu plus, je ne peux pas m’enlever de l’esprit à quel point le mec est vieux, vraiment, je ne peux pas."

# game/script.rpy:586
translate french start_0a340a2f:

    # "Ugh, I’m really no better than the rest..."
    "Argh, je ne vallait vraiment pas mieux que les autres..."
...
translate french start_c7cfcd72:
    ...
    "Ça devait être l’ange sur mon épaule qui me dit, {w=0.2}{cps=100}“Ne ruine pas leur bonne fortune! {w=0.2}Ils sont probablement si heureux là tout de suite! {w=0.2}Et puis, c’est pas tes oignons!”"

# game/script.rpy:592
translate french start_e60d580b:

    # "Gosh, yes, that must be it."
    "Mais oui, ça devait être ça."

# game/script.rpy:593
translate french start_fe8c20f5:

    # extend " That explains everything."
    extend " Ça expliquerait tout."
...
translate french start_55a3bf7d:
    ...
    extend " Non pas qu’il y en eût un."

# game/script.rpy:605
translate french start_33e4ca6f:

    # "{cps=80}So let’s keep silent and everyone will be happy!"
    "{cps=80}Alors, restons silencieuse et tout le monde sera heureux!"
...
translate french start_c48d9f88:
    ...
    extend " Aaah, qu’il est bon de ne rien avoir sur la conscience."

# game/script.rpy:610
translate french start_59e18383:

    # "{cps=80}Welp, no need to loaf around here any longer!"
    "{cps=80}Voilà, je n’avais aucune raison pour traîner ici plus longtemps!"

# game/script.rpy:611
translate french start_468e837f:

    # extend " Guess I better head home!"
    extend " J’imagine que je devrais rentrer chez moi!"
...
translate french start_73a8f757:
    ...
    "{cps=100}Et si, écoute-moi bien, et si Ira avait vraiment disparu?"

# game/script.rpy:620
translate french start_e44cf88d:

    # extend " Despite all odds, there’s always a possibility that she is in danger."
    extend " Malgré tout, il y avait toujours une possibilité qu’elle soit vraiment en danger."
...
translate french start_16328e8d:
    ...
    "{cps=100}Et si il y avait la moindre chance que mon signalement aide à la retrouver, alors cette information méritait d’être partagée!"
...
translate french start_be60bc2d:
    ...
    "{cps=100}Mais si elle s’était vraiment enfuie avec son amant,\nalors mon témoignage ne fera rien avancer."

# game/script.rpy:623
translate french start_aaccd201:

    # extend " It's worthless at worst!"
    extend " Au pire, il servira vraiment à rien!"
...
translate french start_b6ef972f:
    ...
    "{cps=100}Si je pesais minutieusement le pour et le contre, le fait qu’Ira soit éventuellement en danger et que mes mots fussent peut-être la clé pour la sauver était un sacré argument de taille."
...
translate french start_67f68254:
    ...
    extend " “Que mes mots fussent peut-être la clé pour la sauver”..."
...
translate french start_ccee20c7:
    ...
    extend " {cps=100}Ça serait si incroyable!"
...
translate french start_4c527c6f:
    ...
    "{cps=100}Et quand j’irais lui rendre visite à l’hôpital, elle ne saura pas comme me remercier."

# game/script.rpy:638
translate french start_31379655:

    # extend " She’d say I shouldn’t have, she’d say, {w=0.2}“I told you to leave me alone, dummy”."
    extend " Elle dira que je n’aurais pas dû, et me dira après, {w=0.2}“Je t’ai dit de me laisser tranquille, idiote”."
...
translate french start_ac52cfe5:
    ...
    extend " Descends les escaliers, vers la gauche, traverse le couloir."

# game/script.rpy:669
translate french start_43db9e3b:

    # "There, that’s the teacher’s office!"
    "Là, le bureau des professeurs!"
...
translate french start_64891d92:
    ...
    extend " Il y avait une fille se tenant là, juste devant la porte."

# game/script.rpy:685
translate french start_af1edad2:

    # "I think I’ve seen her before..."
    "Je crois que je l’avais déjà vue auparavant..."

# game/script.rpy:686
translate french start_34fe90e1:

    # extend " Is she an upperclassman?"
    extend " Était-elle une étudiante plus âgée?"
...
translate french start_8a8212bd:
    ...
    "Notre ville est vraiment minuscule, tout comme notre école – Si j’étais une meilleure personne, je connaîtrais son nom."
...
translate french start_e34d5de2:
    ...
    extend " Je n’étais pas sûre de ce qu’elle attendit, donc je hocha un peu la tête."
...
translate french start_2ddb273a:
    ...
    extend " Est-ce qu’il y a une queue?"
...
translate french start_414b8ee2:
    ...
    extend " J’attendais juste quelqu’un."
...
translate french start_47d57edf:
    ...
    extend " Tu me connais aussi, n’est-ce pas?"
...
translate french start_070becd0:
    ...
    "{cps=100}Eh, c'était justement le truc auquel j’étais en train de penser juste avant...!"

# game/script.rpy:745
translate french start_a58596ae:

    # "It’s not that I don’t care to remember everyone’s names."
    "Ce n’était pas que je m’en fichait de me souvenir des prénoms de tout le monde."
...
translate french start_3bb01d90:
    ...
    "Ils disent que dans de si petites villes comme celle-ci tout le monde se connaît, mais ce n’est juste pas vrai."
...
translate french start_2a4b0753:
    ...
    "Nous apprenons la présence des gens en dehors de notre cercle social immédiat par les ragots ou des amis communs."

# game/script.rpy:749
translate french start_52ff36a8:

    # extend " But I haven’t made any new ones since the day Tosya left."
    extend " Mais je ne m’en était pas fait de nouveaux depuis que Tosya était partie."
...
translate french start_0da34f20:
    ...
    "Bien sûr, j’entendais parfois mes camarades de classe discuter de ceci ou de cela."
...
translate french start_d9047790:
    ...
    "Mais je n’aimais pas les écouter, je n’aimais pas leurs voix, alors j’essayais de ne pas y prêter attention."
...
translate french start_90718421:
    ...
    extend " Quand je l’énonce de cette manière, ça sonne un peu comme si c’était de ma faute..."
...
translate french start_cd8e37aa:
    ...
    m "Ravie de te rencontrer aussi."

# game/script.rpy:769
translate french start_7425bc38:

    # extend " You got something to share about Grachevskaya?"
    extend " As-tu quelque chose à partager à propos de Grachevskaya?"
...
translate french start_57db30b4:
    ...
    extend " Nous avons eu une annonce, tout comme toi."
...
translate french start_8d946cae:
    ...
    "Pour une raison ou une autre, je pensais que nous, les camarades d’Ira, étions les seuls à savoir qu’elle avait disparu."
...
translate french start_66b82a71:
    ...
    a neutral "Tu sais aussi quelque chose à propos d’Ira?"
...
translate french start_a340eefb:
    ...
    extend " C’est entre moi et l’enquête."

# game/script.rpy:803
translate french start_0c2879c1:

    # extend " You can't just spout info like that out in the open, Asya."
    extend " Tu ne peux pas juste faire me faire divulger des informations comme ça, à la vue de tous, Asya."
...
translate french start_8a4e20ef:
    ...
    extend " Je faisais une horrible première impression."
...
translate french start_529c3554:
    ...
    "Non seulement je ne savais pas son nom comme j’aurais dû, mais de plus, j’avais l’air de ne même pas connaître la prudence."

# game/script.rpy:815
translate french start_6362ee0a:

    # "{cps=100}Aaagh, who am I kidding!!"
    "{cps=100}Aaagh, mais qui je trompais!!"

# game/script.rpy:816
translate french start_ca18113c:

    # extend " I really don't!!!"
    extend " Je ne savais vraiment pas!!!"
...
translate french start_ee9d035a:
    ...
    extend " Je vais juste y aller alors...!"

# game/script.rpy:820
translate french start_960eaf25:

    # "Marina suddenly blocks my path."
    "Marina bloqua soudainement mon chemin."

# game/script.rpy:824
translate french start_7895fe89:

    # m "Haha, no you won’t."
    m "Haha, tu n’entreras pas."
...
translate french start_181d97cb:
    ...
    "Elle bougea avec son doigt au rythme de chaque syllabe."
...
translate french start_78daf776:
    ...
    "Oh purée, ils ont vraiment parlés de moi?"
...
translate french start_974dc25e:
    ...
    "J’étais si surprise de voir à quel point Marina est amicale, considérant le genre de description qu’Ira aurait pu donner..."
...
translate french start_4a221a7f:
    ...
    extend " Pour une raison ou une autre, je n’aurais pas pensé qu’elle en avait, en tout cas, pas à l’école."

# game/script.rpy:873
translate french start_8755da55:

    # extend " That was really presumptuous of me."
    extend " C’était très présomptueux de ma part."

# game/script.rpy:874
translate french start_44495e86:

    # "I wonder what Ira is like when she’s with friends."
    "Je me demandais comment était Ira lorsqu’elle est avec ses amis."
...
translate french start_8c17dfbd:
    ...
    extend " J’imagine que ça aurait été plus facile entre les cours, mais, haha..."

# game/script.rpy:887
translate french start_7a2223c2:

    # m "I got so caught up in all of those stupid rumours!"
    m "Je me suis laissée emportée par toutes ces rumeurs stupides!"

# game/script.rpy:888
translate french start_1e81755f:

    # extend " It kinda slipped my mind."
    extend " Donc ça m’était sorti de l’esprit."
...
translate french start_ad580f97:
    ...
    m "Mais hé, tout ce qui compte, c’est que ça a marché!"
...
translate french start_7b68d4d5:
    ...
    extend um " Alors, pourquoi tu m’arrêtes?"
...
translate french start_faad256c:
    ...
    "Elle recula avant de me faire signe avec sa main."

# game/script.rpy:909
translate french start_e3c08905:

    # extend " I’m not sure what she has in mind, but it doesn’t seem like a prank."
    extend " Je n’étais pas sûre de ce qu’elle avait en tête, mais ça ne semblait pas être une blague."
...
translate french start_04c72c6c:
    ...
    "Marina attrapa ma main et commença à me traîner dans le couloir."

# game/script.rpy:929
translate french start_51db41e8:

    # extend " She’s not exactly being quiet either!"
    extend " Elle n’était pas très silencieuse d’ailleurs!"
...
translate french start_968327c4:
    ...
    "Toutes mes protestations maladroites sonnèrent si faiblemment que ça pourrait être du bruit blanc pour l’autre fille."

# game/script.rpy:931
translate french start_b4e7ac64:

    # "Yes, I spent half the day doubting whether I should report at all!"
    "Oui, j’ai passé la moitié de la journée à douter si je devrais rapporter ou pas ce que j’avais vu!"
...
translate french start_e1e4503c:
    ...
    "J’avais minutieusement examiné toutes mes options et j’en étais arrivée à ma conclusion!"

# game/script.rpy:934
translate french start_874815b7:

    # extend " I deserve to see it though!"
    extend " Je méritais de voir ça!" 
...
translate french start_5f9ae42f:
    ...
    extend "Mais une partie de moi était soulagée que le choix final ait été fait pour moi."
...
translate french start_c1dfbc83:
    ...
    "{cps=80}Est-ce que Marina s’était révélée parce que le monde avait besoin de m’arrêter dans l’intérêt de quelque chose de plus important?"
...
translate french start_3ee476cc:
    ...
    extend " {cps=80}Ou est-ce qu’elle s’était révélée parce que j’ai souhaité subconsciamment de quelque chose, de quelqu’un pour m’arrêter?"

# game/script.rpy:948
translate french start_88c79c79:

    # "{cps=80}Whatever it was, I guess I don’t mind this after all."
    "{cps=80}Qu’importe ce que c’était, J’imagine que ça m’était égal après tout."
...
translate french start_3376fff9:
    ...
    "Je pense que j’allais m’en tenir à un point de vue plus global pour le moment."

# game/script.rpy:956
translate french start_c023596b:

    # extend " The world bending itself to the will of some worthless gnat is a preposterous idea."
    extend " L’idée que le monde lui-même se tordait face à la volonté d’un moucheron sans valeur était présomptueux."
